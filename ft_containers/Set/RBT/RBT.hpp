...
/*   Updated: 2022/01/03 20:37:53 by wben-sai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class Rbt
    {
        public :
            ...
            typedef Node<key_type>                                                                      Node_val;
            typedef Node<key_type>&                                                                     Node_ref;
            typedef Node<key_type>*                                                                     Node;
            typedef s_iterator<Rbt<key_type, key_compare>, Node_val, key_compare, const key_type>       const_iterator;
            typedef s_iterator<Rbt<key_type, key_compare>, Node_val, key_compare, key_type>             iterator;
        ...
        public :
            ...
            iterator find (const key_type& k) const
            {
                ...
                while(temp_node)
                {
                    if(_mycomp(k, *(temp_node->data)))
                        temp_node = temp_node->left;
                    else if (_mycomp(*(temp_node->data), k))
                        temp_node = temp_node->right;
                    else
            ...
            size_type count (const key_type& k) const
            {
                ...
                while(temp)
                {
                    if(_mycomp(k, *(temp->data)))
                        temp = temp->left;
                    else if (_mycomp(*(temp->data), k))
                        temp = temp->right;
                    else
                        return (1);
                }
            ...
            pair<iterator,bool> insert (const key_type& val)
            {
                ...
                {     // create now node as leef node with color red
                    ...
                    while(true)
                    {
                        if(_mycomp(*(newnode->data), *(temp_node->data)))
                        {
                        ...
                        else if (_mycomp(*(temp_node->data), *(newnode->data)))
                        {
                    ...
                    if(_mycomp(*(newnode->data), *(_first_node->data)))
                    {
                        _first_node->is_begin = false;
                        _first_node = newnode;
                        _first_node->is_begin = true;
                    }
                    if(_mycomp(*(_last_node->data), *(newnode->data)))
                    {
        ...
        private : 
            ...
            Node create_node(const key_type& val)
            {
                Node    new_node;
            ...
            void update_first_last(Node_ref ptr)
            {
                ...
                if(temp->is_begin)
                {
                    ...
                    else
                    {
                        ...
                        {
                            temp = temp->parent;
                            if(_mycomp(*(temp->data), *(temp->data)))
                            {
                                temp->is_begin = true;
                                _first_node = temp;
                                break;
            ...
            public :
                ...
                void printBT(const std::string& prefix, const Node node1, bool isLeft)
                {
                    if( node1 != NULL )
                    {
                        ...
                        if(node1->parent)
                            std::cout << " parent " << node1->parent->data;
                        std::cout << "\n";
